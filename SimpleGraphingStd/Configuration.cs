...
namespace SimpleGraphingStd
{
    ...
    public class Configuration : ISerializable
    {
        ...
        public Configuration(SerializationInfo info, StreamingContext context)
        {
            ...
            {
                ConfigurationFrame frame = (ConfigurationFrame)info.GetValue($"frame_{i}", typeof(ConfigurationFrame));
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            {
                info.AddValue($"frame_{i}", m_rgFrameConfig[i], typeof(ConfigurationFrame));
            }
        }
        ...
        public static Configuration LoadFromFile(string strFile)
        {
            ...
            if (strXml.Length > 1 && (int)strXml[0] == 65533 && (int)strXml[1] == 65533)
